...
g
# ggsave(file=  "./02_output/English/check_definition.png", plot = g, , dpi = 100, width = 9, height = 6)
...
g
# ggsave(file=  "./02_output/English/distance_per_game_league.png", plot = g, , dpi = 100, width = 8, height = 6)
...
g
# ggsave(file=  "./02_output/English/average_speed_league.png", plot = g, , dpi = 100, width = 8, height = 6)
...
g
# ggsave(file=  "./02_output/English/average_speed_rank_top10.png", plot = g, dpi = 100, width = 12, height = 9)
...
g
# ggsave(file=  "./02_output/English/average_speed_rank_bottom10.png", plot = g, dpi = 100, width = 12, height = 9)
...
g
# ggsave(file=  "./02_output/English/average_speed_OFF_rank_top10.png", plot = g, dpi = 100, width = 12, height = 9)
...
g
# ggsave(file=  "./02_output/English/average_speed_OFF_rank_bottom10.png", plot = g, dpi = 100, width = 12, height = 9)
...
g
# g %>% ggexport(filename =  "./02_output/English/average_speed_rank_top20_all_num.png",width = 800, height = 600)
...
# タイトルとテーブルを組み合わせ
g
# g %>% ggexport(filename =  "./02_output/English/average_speed_rank_bottom20_all_num.png",width = 800, height = 600)
...
g
g %>% ggexport(filename =  "./02_output/English/average_speed_rank_top20_player_all_num.png",width = 800, height = 600)
...
# タイトルとテーブルを組み合わせ
g
# g %>% ggexport(filename =  "./02_output/English/average_speed_rank_bottom20_player_all_num.png",width = 800, height = 600)
...
g
# ggsave(file=  "./02_output/English/average_speed_win_ratio.png", plot = g, dpi = 100, width = 12, height = 9)
...
g
# ggsave(file=  "./02_output/English/average_speed_team_season.png", plot = g, , dpi = 100, width = 18, height = 12)
...
g %>% ggexport(filename =  "./02_output/English/average_speed_yoy_rank_top20_team_all_num.png",width = 800, height = 600)
...
g
# 2024-25のSASは特徴的？
# g %>% ggexport(filename =  "./02_output/English/average_speed_yoy_rank_bottom20_team_all_num.png",width = 800, height = 600)
...
g <- r_player %>%
  ...
  ggplot(aes(x = season, y = Avg_Speed, group = 1))+
  geom_line(linewidth = 1.1)+
  geom_text(aes(label = MIN), vjust = 0.3, hjust = 1.2, size = 3.5)+
  geom_point(size = 2)+
  labs(
    title = "Lebron James Average Speed each year",
    subtitle = "The number in the graph is playing time(min)",
    x = "season",
    y = "Average Speed(mph)",
  )+
  theme_bw()+
...
g
ggsave(file=  "./02_output/English/average_speed_player_lbj_season.png", plot = g, , dpi = 100, width = 9, height = 6)
## カリー -------------------------------------------------------------
g <- r_player %>%
...
g
# ggsave(file=  "./02_output/English/average_speed_player_curry_season.png", plot = g, , dpi = 100, width = 9, height = 6)
...
g
# ggsave(file=  "./02_output/English/average_speed_player_jokic_season.png", plot = g, dpi = 100, width = 9, height = 6)
...
g
# ggsave(file=  "./02_output/English/average_speed_player_sga_season.png", plot = g, dpi = 100, width = 9, height = 6)
...
g
# ggsave(file=  "./02_output/English/average_speed_player_kd_season.png", plot = g, dpi = 100, width = 9, height = 6)
...
g
# KDは面白そう
# g %>% ggexport(filename =  "./02_output/English/average_speed_yoy_rank_top20_player_all_num.png",width = 800, height = 600)
...
g
# SGAは面白そう
# g %>% ggexport(filename =  "./02_output/English/average_speed_yoy_rank_bottom20_player_all_num.png",width = 800, height = 600)
...
g
# 察せるものがある
g %>% ggexport(filename =  "./02_output/English/average_speed_off_def_ratio_rank_top20_team.png",width = 800, height = 600)
...
# g %>% ggexport(filename =  "./02_output/English/average_speed_off_def_ratio_rank_bottom20_player.png",width = 800, height = 600)
...
g
# 察せるものがある
g %>% ggexport(filename =  "./02_output/English/average_speed_off_def_ratio_rank_top20_player.png",width = 800, height = 600)
